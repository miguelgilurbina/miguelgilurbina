    ...
    items: [
      {
        ...
        metrics: [
          ...
          { value: "1,834", label: "evaluations recorded (Fintech edition)" },
          { value: "4",     label: "Claude agents in production" },
        ],
        bullets: [
          "Multi-tenant architecture: tracks, rules, rubric, branding and dates resolve per vertical, so standing up the second vertical — different domain, different partner, different rubric — was configuration rather than a fork of the project.",
  ...
  services: {
    ...
    areas: [
      ...
      },
      {
        ...
        evidence: "Claude Impact Lab Chile: the platform that ran both verticals of Anthropic's program in the country — Fintech and Longevity — with four Claude agents in production. 899 applications and 1,834 evaluations in the first edition alone. Plus the Caquetío Simulator — sixty agents and a control experiment — and nine months evaluating models at Outlier.",
