    ...
    items: [
      {
        ...
        metrics: [
          ...
          { value: "1.834", label: "evaluaciones registradas (edición Fintech)" },
          { value: "4",     label: "agentes Claude en producción" },
        ],
        bullets: [
          "Arquitectura multi-tenant: tracks, reglas, rúbrica, marca y fechas se resuelven por vertical, así que montar la segunda vertical —otro dominio, otro partner, otra rúbrica— fue configuración y no un fork del proyecto.",
  ...
  services: {
    ...
    areas: [
      ...
      },
      {
        ...
        evidence: "Claude Impact Lab Chile: la plataforma que corrió las dos verticales del programa de Anthropic en el país —Fintech y Longevidad— con cuatro agentes Claude en producción. 899 postulaciones y 1.834 evaluaciones solo en la primera edición. Más el Simulador Caquetío —sesenta agentes y experimento de control— y nueve meses evaluando modelos en Outlier.",
