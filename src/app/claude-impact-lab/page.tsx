...
const COPY = {
  es: {
    ...
    kicker: "Claude Impact Lab Chile 2026",
    partners: "Bendita IA × FinteChile · Anthropic como Technical Partner",
    titleA: "Agentes que no deciden,",
    titleB: " pero hacen posible decidir",
    intro: "La plataforma que operó el primer Claude Impact Lab de América Latina, en el Chile Fintech Forum 2026. Fui Lead Frontend del proyecto: el leaderboard en vivo, el portal de evaluadores y el motor de puntaje.",
  ...
  en: {
    ...
    kicker: "Claude Impact Lab Chile 2026",
    partners: "Bendita IA × FinteChile · Anthropic as Technical Partner",
    titleA: "Agents that don't decide,",
    titleB: " but make deciding possible",
    intro: "The platform that ran the first Claude Impact Lab in Latin America, at Chile Fintech Forum 2026. I was Lead Frontend on the project: the live leaderboard, the evaluator portal and the scoring engine.",
