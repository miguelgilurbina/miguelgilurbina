...
export default function HistoriaPage() {
  return (
    <div className="bg-background text-foreground">
      ...
      {/* HERO */}
      <header className="relative overflow-hidden bg-gradient-to-br from-[#0f172a] to-[#1e293b] px-6 py-24 text-center text-white">
        <div
        ...
        <div className="relative">
          <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-blue-400/40 bg-blue-600/25 px-4 py-1.5 text-[13px] font-medium tracking-wide text-blue-300">
            <IconBolt className="size-3.5" />
            Cargo Electric · Dashboard Web
          </div>
          <h1 className="mx-auto mb-5 max-w-3xl text-[clamp(2rem,5vw,3.25rem)] leading-[1.15] font-bold tracking-tight">
            De múltiples hojas de cálculo
            <br />
            <span className="text-blue-400">a una plataforma centralizada</span>
          </h1>
          <p className="mx-auto max-w-xl text-lg text-slate-400">
            Cargo Electric gestionaba su flota eléctrica con Google Sheets dispersos. Construimos una plataforma
            que centraliza la operación, la analítica y la facturación — todo en tiempo real.
          </p>
        </div>
      </header>
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {milestones.map((milestone) => {
                ...
                return (
                  <div key={milestone.title} className="relative flex gap-7">
                    <div
                      className={cn(
                    ...
                    <div className="flex-1 pt-2.5">
                      ...
                      <h3 className="mb-1.5 text-[1.0625rem] font-semibold">{milestone.title}</h3>
      ...
      <section id="plataforma" className="bg-muted/40 px-6 py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <h2 className="mb-3 text-[clamp(1.5rem,3vw,2rem)] font-bold tracking-tight">La plataforma hoy</h2>
          <p className="mb-14 max-w-2xl text-[1.0625rem] text-muted-foreground">
            ...
            {featureBlocks.map((block) => (
              ...
              >
                <div>
                  ...
                  <h3 className="mb-3 text-[1.375rem] font-bold tracking-tight">{block.title}</h3>
      ...
      <section id="administracion" className="px-6 py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-7 md:grid-cols-3">
            {adminCards.map((card) => (
              <div key={card.tag} className="overflow-hidden rounded-xl border bg-card shadow-sm">
                <div className="border-b px-5 pt-4 pb-3.5">
                  <span className="mb-2 inline-block rounded bg-primary/10 px-2 py-0.5 text-[11px] font-semibold tracking-[0.08em] text-primary uppercase">
                    {card.tag}
                  </span>
      ...
      <section id="arquitectura" className="px-6 py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mb-10 max-w-2xl text-[1.0625rem] text-muted-foreground">
            Stack técnico en producción: desde la autenticación y los módulos de la app hasta la base de datos
            operacional y las exportaciones generadas en el cliente.
          </p>
          <ArchitectureDiagram />
        </div>
      </section>
